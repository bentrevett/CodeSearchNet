...
if args.model == 'bow':
    ...
    code_pooler = models.EmbeddingPredictor(args.emb_dim,
                                            len(LABEL.vocab),
                                            args.pool_mode)
...
def train(code_encoder, code_pooler, iterator, optimizer, criterion):
...
def evaluate(code_encoder, code_pooler, iterator, criterion):
